...
include_once('modules/Accounting/Import/error.php');
...
checkFileAccess('modules/Accounting/Import/ImportStep'. $_REQUEST['step']. '.php');
include_once('modules/Accounting/Import/ImportStep'. $_REQUEST['step']. '.php');
