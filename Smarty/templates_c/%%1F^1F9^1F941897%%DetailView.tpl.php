<?php /* Smarty version 2.6.18, created on 2015-02-04 15:57:41
         compiled from modules/Accounting/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'modules/Accounting/DetailView.tpl', 192, false),array('modifier', 'getTranslatedString', 'modules/Accounting/DetailView.tpl', 202, false),array('modifier', 'count', 'modules/Accounting/DetailView.tpl', 217, false),array('modifier', 'replace', 'modules/Accounting/DetailView.tpl', 380, false),)), $this); ?>
...
?>
							<?php if ($this->_tpl_vars['header'] == $this->_tpl_vars['MOD']['LBL_ADDITIONAL_INFO']): ?>
									<?php if ($this->_tpl_vars['CONFIG']['showvat'] == 'true'): ?>
										<?php $this->assign('displayVAT', ""); ?>
									<?php else: ?>
										<?php $this->assign('displayVAT', 'none'); ?>
									<?php endif; ?>

									<?php if ($this->_tpl_vars['CONFIG']['associnvoice'] == 'true'): ?>
										<?php $this->assign('displayInv', ""); ?>
									<?php else: ?>
										<?php $this->assign('displayInv', 'none'); ?>
									<?php endif; ?>

								   <table id="payments_table" width="70%">
								   		<tr>
											<th>#</th>
											<th><?php echo $this->_tpl_vars['MOD']['LBL_PAYMENT_REF']; ?>
</th>
											<th><?php echo $this->_tpl_vars['MOD']['LBL_TRANSACTION_METHOD']; ?>
</th>
																						<th><?php echo $this->_tpl_vars['MOD']['LBL_PARTIAL_AMOUNT']; ?>
</th>
											<th style="display: <?php echo $this->_tpl_vars['displayVAT']; ?>
"><?php echo $this->_tpl_vars['MOD']['LBL_PARTIAL_TAX']; ?>
</th>
											<th><?php echo $this->_tpl_vars['MOD']['LBL_TRANSACTION_DUE_DATE']; ?>
</th>
											<th><?php echo $this->_tpl_vars['MOD']['LBL_TRANSACTION_DATE']; ?>
</th>
											<th style="display: <?php echo $this->_tpl_vars['displayInv']; ?>
"><?php echo $this->_tpl_vars['MOD']['RelatedTo']; ?>
</th>
											<th><?php echo $this->_tpl_vars['MOD']['LBL_PARTIAL_PAID_AMOUNT']; ?>
</th>
										</tr>
									   		<?php $_from = $this->_tpl_vars['PAYMENTS']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['foo'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['foo']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['PAYMENT']):
        $this->_foreach['foo']['iteration']++;
?>
									   			<?php if ($this->_tpl_vars['PAYMENT']['paid'] == '1'): ?>
									   				<?php $this->assign('bgColor', "#D7FFD7"); ?>
									   			<?php elseif ($this->_tpl_vars['PAYMENT']['expired'] == '1'): ?>
									   				<?php $this->assign('bgColor', "#FF9D9D"); ?>
									   			<?php else: ?>
									   				<?php $this->assign('bgColor', "#FFFFFF"); ?>
									   			<?php endif; ?>
											   		<tr bgcolor="<?php echo $this->_tpl_vars['bgColor']; ?>
">
											   			<td name="nPayment"><font size="+1"><?php echo ($this->_foreach['foo']['iteration']-1)+1; ?>
</font></td>
											   			<td align="center"><?php echo $this->_tpl_vars['PAYMENT']['ref']; ?>
</td>
											   			<td align="center"><?php echo $this->_tpl_vars['PAYMENT']['method']; ?>
</td>
											   			<td align="center"><?php echo $this->_tpl_vars['PAYMENT']['amount']; ?>
</td>
											   			<td style="display: <?php echo $this->_tpl_vars['displayVAT']; ?>
" align="center"><?php echo $this->_tpl_vars['PAYMENT']['tax']; ?>
</td>
											   			<td align="center"><?php echo $this->_tpl_vars['PAYMENT']['paymentduedate']; ?>
</td>
											   			<td align="center"><?php echo $this->_tpl_vars['PAYMENT']['date']; ?>
</td>
											   			<?php if ($this->_tpl_vars['PAYMENT']['paid'] == '1'): ?>
											   				<?php $this->assign('paidImg', "themes/images/enabled.gif"); ?>
											   			<?php else: ?>
											   				<?php $this->assign('paidImg', "themes/images/disabled.gif"); ?>
											   			<?php endif; ?>
											   			<td style="display: <?php echo $this->_tpl_vars['displayInv']; ?>
" align="center"><strong><a href="index.php?module=<?php echo $this->_tpl_vars['PAYMENT']['assoc_mod']; ?>
&parenttab=Sales&action=DetailView&record=<?php echo $this->_tpl_vars['PAYMENT']['associnv']; ?>
"><?php echo $this->_tpl_vars['PAYMENT']['assoc_display']; ?>
</a></strong></td>
											   			<td align="center"><img src="<?php echo $this->_tpl_vars['paidImg']; ?>
"></td>
											   		</tr>
										   	<?php endforeach; endif; unset($_from); ?>
								   	</table>
								   	<table align="right" CELLSPACING=5>
								   		<tr>
								   			<td bgcolor="#D7FFD7" width="12px" style="border: 1px; border-style: solid;border-color: grey"></td><td><?php echo $this->_tpl_vars['MOD']['LBL_PAID_STATE_COMBOBOX']; ?>
</td>
								   			<td bgcolor="#FF9D9D" width="12px" style="border: 1px; border-style: solid;border-color: grey"><td><?php echo $this->_tpl_vars['MOD']['LBL_OUT_OF_DATE']; ?>
</td>
								   			<td bgcolor="#FFFFFF" width="12px" style="border: 1px; border-style: solid;border-color: grey"><td><?php echo $this->_tpl_vars['MOD']['LBL_PENDING_STATE_COMBOBOX']; ?>
</td>
								   		</tr>
								   	</table>
							<?php endif; ?>
...
></input> (<?php echo $this->_tpl_vars['keycursymb']; ?>
				...
				<?php else: ?>
					<?php if ($this->_tpl_vars['keyfldname'] == 'uniqueid'): ?>
						<?php $this->assign('DISPLAY_FLD2', 'none'); ?>
					<?php else: ?>
						<?php $this->assign('DISPLAY_FLD2', ""); ?>
					<?php endif; ?>

					<td style="display: <?php echo $this->_tpl_vars['DISPLAY_FLD2']; ?>
" class="dvtCellLabel" align=right width=25%>
						<input type="hidden" id="hdtxt_IsAdmin" value=<?php echo $this->_tpl_vars['keyadmin']; ?>
></input><?php echo $this->_tpl_vars['label']; ?>
				...
				<?php if ($this->_tpl_vars['EDIT_PERMISSION'] == 'yes' && $this->_tpl_vars['display_type'] != '2'): ?>
						...
						<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/Accounting/DetailViewUI.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
					<?php else: ?>
						<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/Accounting/DetailViewFields.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
					<?php endif; ?>
