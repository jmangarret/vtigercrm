...
*  Language     : RU Русский
*  Version      : 5.1.0RC
*  Created Date : 2009-07-08 23:03:28 Last change : 2009-07-11 15:43:25
*  Author       : Eugene Babiy
*  License      : 
...
var alert_arr = {
      ...
      NOT_ALLOWED_TO_EDIT_FIELDS:'Вам не разрешено редактировать это поле',
      COLUMNS_CANNOT_BE_EMPTY:'Выбранные Колонки не могут быть пустые',
      ...
      PORTAL_PROVIDE_EMAILID:'Пользователь Портала должен предоставить адрес почты для входа',
      ADD_CONFIRMATION:'Вы уверены что хотите добавить избранное ',
      ACCOUNTNAME_CANNOT_EMPTY:'ИмяКонтрагента не может быть Пустым',
      CANT_SELECT_CONTACTS:'Вы не можете выбрать связанные контакты с Кандидатов',
      LBL_THIS:'Этот ',
