...
if($recordid == "")
{
	...
	$smarty->assign("COLUMNS_BLOCK",$choosecolhtml);

	$oCustomView->mandatoryvalues[] = "'vtiger_accounting:accounting_id:accounting_id:Accounting_PaymentId:V'";
	$oCustomView->showvalues[] = "PaymentId";
...
$smarty->assign("MUSTHAVE_ACCOUNTING_ID_FIELD", str_replace("\"", "'", $mod_strings_aux['MUSTHAVE_ACCOUNTING_ID_FIELD']));

global $vtiger_current_version;
if (version_compare($vtiger_current_version, '5.3.0') >= 0) {
	$smarty->assign("AX_ADV_FILTER_PATCH", "true");
}

$smarty->display(vtlib_getModuleTemplate("Accounting", "CustomView.tpl"));
