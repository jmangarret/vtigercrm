    ...
    <form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="index.php" enctype="multipart/form-data">
        ...
        <div class="contentHeader row-fluid">
            ...
            <span class="pull-right">
                <button class="btn btn-success" type="submit" onclick="document.EditView.redirect.value = 'false'; if(PDFMaker_EditJs.savePDF()) this.form.submit();" ><strong>{vtranslate('LBL_APPLY','PDFMaker')}</strong></button>&nbsp;&nbsp;
       ...
       {************************************** END OF TABS BLOCK *************************************}                         
        ...
        <script type="text/javascript">
            {literal} CKEDITOR.replace('header_body', {height: '1000'}); {/literal} 
        </script>
        ...
        <script type="text/javascript">
            {literal} CKEDITOR.replace('footer_body', {height: '1000'}); {/literal} 
        </script>
