...
class HelpDesk extends CRMEntity {
	...
	function save_module($module)
	{
		...
		if ($status=="Open") 	{$title="Se te ha asignado una nuevo caso con los siguientes datos:"; $userid=	$idowner;}
		if ($status=="Closed") 	{$title="Se ha cerrado una tarea/caso con los siguientes datos:"; $userid=	$idcreator;}
