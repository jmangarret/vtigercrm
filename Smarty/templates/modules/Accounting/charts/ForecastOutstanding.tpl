{* CHARTS *}
<div id="ForecastOutstanding_chart" ></div>

<br /><br />
<font color="grey"><strong><div align="center" id="div_empty_result_ForecastOutstanding"></div></strong></font>
...
<div style="display: none" id="notes_{$section}" align="right" style="padding-right:30px">
	...
	<tr><td><font size="1">*** {$CHART_LANG.LBL_NONE_DATE_FILTER}</font></td></tr>
