<?php /* Smarty version 2.6.18, created on 2015-02-04 15:56:39
         compiled from modules/Accounting/ListView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'modules/Accounting/ListView.tpl', 270, false),array('function', 'html_options', 'modules/Accounting/ListView.tpl', 304, false),)), $this); ?>
...
{
<?php if ($this->_tpl_vars['SEARCH_53'] == 'true'): ?>
	return callSearch_53(searchtype);
<?php endif; ?>
...
function callSearch_53(searchtype)
{
	for(i=1;i<=26;i++)
    	{
        	var data_td_id = 'alpha_'+ eval(i);
...
unset($_smarty_tpl_vars);
 ?>
	  ...
	  <?php if ($this->_tpl_vars['MODULE'] != 'Documents'): ?>
			<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/Accounting/ListViewEntries.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
	  <?php else: ?>
