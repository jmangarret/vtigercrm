...
require_once('modules/Accounting/Import/ImportLead.php');
require_once('modules/Accounting/Import/ImportAccount.php');
require_once('modules/Accounting/Import/ImportContact.php');
require_once('modules/Accounting/Import/ImportOpportunity.php');
require_once('modules/Accounting/Import/ImportProduct.php');
require_once('modules/Accounting/Import/ImportMap.php');
require_once('modules/Accounting/Import/ImportTicket.php');
require_once('modules/Accounting/Import/ImportVendors.php');
require_once('modules/Accounting/Import/UsersLastImport.php');
require_once('modules/Accounting/Import/parse_utils.php');
require_once('include/ListView/ListView.php');
require_once('include/database/PearDatabase.php');
require_once('modules/Accounting/Import/ImportSave.php');
...
if(isset($datarows) && is_array($datarows)){
	...
	include("modules/Accounting/Import/picklist_addition.php");
}
