<?php /* Smarty version 2.6.18, created on 2015-02-04 15:56:39
         compiled from modules/Accounting/ListViewEntries.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getTranslatedString', 'modules/Accounting/ListViewEntries.tpl', 66, false),array('modifier', 'vtiger_imageurl', 'modules/Accounting/ListViewEntries.tpl', 76, false),array('modifier', 'cleanEntityList', 'modules/Accounting/ListViewEntries.tpl', 179, false),array('function', 'html_options', 'modules/Accounting/ListViewEntries.tpl', 384, false),)), $this); ?>
...
" class="drop_down"><?php echo $this->_tpl_vars['customlink_label']; ?>
                ...
                <td nowrap>
                	<table>
                		<tr>
                			<td>
                				<input onclick="changePartialView();" type="checkbox" name="partialpayments" id="partialpayments" value="" <?php echo $this->_tpl_vars['PARTIAL_PAYMENT_VIEW']; ?>
><?php echo $this->_tpl_vars['MOD']['LBL_PARTIAL_PAYMENTS_VIEW']; ?>
</input>
                			</td>
                		</tr>
                	</table>
...
"><?php echo $this->_tpl_vars['APP']['LNK_CV_CREATEVIEW']; ?>
								...
								<?php else: ?>
									<a href="index.php?module=<?php echo $this->_tpl_vars['MODULE']; ?>
&action=CustomViewIndex&record=<?php echo $this->_tpl_vars['VIEWID']; ?>
...
?>
			<?php $this->assign('entity_id2', ((is_array($_tmp=$this->_tpl_vars['entity_id'])) ? $this->_run_mod_handler('cleanEntityList', true, $_tmp) : cleanEntityList($_tmp))); ?>
			<tr bgcolor=white onMouseOver="this.className='lvtColDataHover'" onMouseOut="this.className='lvtColData'" id="row_<?php echo $this->_tpl_vars['entity_id2']; ?>
">
			<td width="2%"><input type="checkbox" NAME="selected_id" id="<?php echo $this->_tpl_vars['entity_id2']; ?>
" value= '<?php echo $this->_tpl_vars['entity_id2']; ?>
' onClick="check_object(this)"></td>
			<?php $_from = $this->_tpl_vars['entity']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['acc_headers'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['acc_headers']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['data']):
        $this->_foreach['acc_headers']['iteration']++;
?>
						<?php $this->assign('omit_head', 'false'); ?>
			<?php $_from = $this->_tpl_vars['OMIT_HEADERS']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['H_ACC']):
?>
				<?php if ($this->_tpl_vars['H_ACC'] == ($this->_foreach['acc_headers']['iteration']-1)): ?>
					<?php $this->assign('omit_head', 'true'); ?>
				<?php endif; ?>
			<?php endforeach; endif; unset($_from); ?>
			<?php if ($this->_tpl_vars['omit_head'] == 'false'): ?>
...
<?php echo $this->_tpl_vars['MERGEBUTTON']; ?>
														   		...
														   		<a href="index.php?module=Accounting&return_module=Accounting&action=AccountingAjax&file=AccountingCharts&src_module=Accounting" target="_blank"><strong><?php echo $this->_tpl_vars['MOD']['LBL_CHART_BALANCE']; ?>
</strong></a>
				   					   					 </td>
			      </tr>
       		    </table>
