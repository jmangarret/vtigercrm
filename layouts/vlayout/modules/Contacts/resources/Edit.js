...
/*
	Funcion para el registro de los contactos al ABM
	//Modify By jmangarret 08jun2015
*/
	function sic_abm(contacto,user){		
		bootbox.confirm("Estas seguro de Sincronizar este Cliente?", function(result) {
			if(result){
				var ajax_data = {
					"cliente" : contacto,
					"user" : user,
				...
				jQuery.ajax({
						data: ajax_data,
						url: 'modules/Contacts/ContactsAjax.php',
						type: 'get',
				...
				bootbox.alert("Ha salido de la Sincronizaci\u00f3n !!!:..");
			}
		}); 
	}
