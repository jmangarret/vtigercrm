		...
		<table  cellpadding="0" cellspacing="0" width="100%" class="small">
		   <tr>
			<td width="75%" valign=top>
				...
				<input type="hidden" name="file" value="ImportStep3">
				...
				<table align="center" cellpadding="5" cellspacing="0" width="95%" class="mailClient importLeadUI small">
				   ...
				   <tr>
					<td align="left" style="padding-left:40px;">
					   ...
					   {$MOD.LBL_STEP_2_TXT} {$MODULELABEL}.<br /><br />
					   *** Please, if you want to import data from a third application or you has edited CSV exported file, contact with <b><a target="_blank" href="http://support.axialblue.com">Axialblue - Support</a></b>
					</td>
				   </tr>
				   <tr>
					<td>&nbsp;</td>
						   ...
						   <tr>
							<td width="25%" valign="top">
								<div id="importmapform">
									{include file="modules/Accounting/ImportMap.tpl"}
								</div>
							</td>
							<td valign="top">
...
<script>
var nrows = {$SELECTFIELD|@count};
{literal}
for (var i=nrows-6; i<nrows; i++) {
	document.getElementById('colnum'+i).style.display = "none";
}
{/literal}
</script>
...
/*
function appendOptionLastavailList(name, num)
{
...
var extra_flds = new Array();
extra_flds.push("amount");
extra_flds.push("paymentdate");
extra_flds.push("paid");
extra_flds.push("paymentduedate");
extra_flds.push("associnv");
extra_flds.push("ref");
extra_flds.push("paymentmethod");
extra_flds.push("tax");

try {
	for(var i=0; i<200; i++) {
		for (var j=0; j<extra_flds.length; j++) {
			appendOptionLastavailList('colnum'+i, extra_flds[j]);
		}
	}
} catch (e) {
}
