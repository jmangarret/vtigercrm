<?php /* Smarty version Smarty-3.1.7, created on 2015-06-29 11:42:31
         compiled from "/var/www/vhosts/registro.tuagencia24.com/vtigercrm/includes/runtime/../../layouts/vlayout/modules/Vtiger/CommonActions.tpl" */ ?>
<?php /*%%SmartyHeaderCode:38677065054d243c9884959-71768861%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a7b700f20d611b6fb6ecbbd3cc11464bad186e7a' => 
    array (
      0 => '/var/www/vhosts/registro.tuagencia24.com/vtigercrm/includes/runtime/../../layouts/vlayout/modules/Vtiger/CommonActions.tpl',
      1 => 1435594270,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '38677065054d243c9884959-71768861',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_54d243c9a2df5',
  'variables' => 
  array (
    'ANNOUNCEMENT' => 0,
    'USER_MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_54d243c9a2df5')) {function content_54d243c9a2df5($_smarty_tpl) {?>
...
" results="10" /><span id="searchIcon" class="add-on search-icon"><i class="icon-white icon-search "></i></span><!--Modified by jmangarret 16jun2015 --><?php if ($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('roleid')!='H9'){?><span class="adv-search"><a class="alignMiddle" id="globalSearch"><?php echo vtranslate('LBL_ADVANCE_SEARCH');?>
</a></span><?php }?></div></div><div class="notificationMessageHolder span3"></div><div class="nav quickActions btn-toolbar span2 pull-right"><div class="pull-right commonActionsButtonContainer"><?php if (!empty($_smarty_tpl->tpl_vars['announcement']->value)){?><div class="btn-group cursorPointer"><img class='alignMiddle' src="<?php echo vimage_path('btnAnnounceOff.png');?>
