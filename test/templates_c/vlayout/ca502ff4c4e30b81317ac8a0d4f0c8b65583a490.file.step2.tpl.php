<?php /* Smarty version Smarty-3.1.7, created on 2015-02-20 16:45:33
         compiled from "/var/www/vhosts/registro.tuagencia24.com/vtigercrm/includes/runtime/../../layouts/vlayout/modules/Reports/step2.tpl" */ ?>
<?php /*%%SmartyHeaderCode:200841640754e764ad04bf81-61533737%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ca502ff4c4e30b81317ac8a0d4f0c8b65583a490' => 
    array (
      0 => '/var/www/vhosts/registro.tuagencia24.com/vtigercrm/includes/runtime/../../layouts/vlayout/modules/Reports/step2.tpl',
      1 => 1423065964,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '200841640754e764ad04bf81-61533737',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54e764ad488ac',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54e764ad488ac')) {function content_54e764ad488ac($_smarty_tpl) {?>
...
" /><input type="hidden" class="step" value="2" /><div class="well padding1per contentsBackground"><div class="row-fluid block"><div class="row span"><strong><?php echo vtranslate('LBL_SELECT_COLUMNS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
(<?php echo vtranslate('LBL_MAX',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 25)</strong></div><div class="row-fluid row span"><select data-placeholder="<?php echo vtranslate('LBL_ADD_MORE_COLUMNS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</option><?php } ?></optgroup><?php } ?><?php } ?></select></div></div><div class="row-fluid block"><div class="row-fluid row span"><span class="span6"><strong><?php echo vtranslate('LBL_GROUP_BY',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
-<?php echo vtranslate($_smarty_tpl->tpl_vars['CALCULATION_FIELD']->value,$_smarty_tpl->tpl_vars['MODULE']->value);?>
