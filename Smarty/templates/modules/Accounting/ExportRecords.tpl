...
<form  name="Export_Records_Payments"  method="POST"">
    				...
    				<tr>
 					<td width="50%" valign=top>
						<form  name="Export_Records"  method="POST" onsubmit="VtigerJS_DialogBox.block();">
							<input type="hidden" name="module" value="{$MODULE}">
							<input type="hidden" name="file" value="ExportPayments">
							<input type="hidden" name="action" value="AccountingAjax">
							<input type="hidden" name="idstring" value="{$IDSTRING}">
							<input type="hidden" name="id_cur_str" value="{$IDCURSTR}">
							<table align="center" cellpadding="15" cellspacing="0" width="85%" class="mailClient importLeadUI small" border="0">
  									...
  									<td border="0" cellpadding="5" cellspacing="0" width="50%">
	 									<table>
											...
											<tr>
			   								...
			   								<tr>
			        								<td align="right" valign="top" width="50%" class=small ><font color="red">***</font> {$APP.LBL_DATA_IN_CURRENT_PAGE}</td>
												<td align="left" valign="top" width="5%" class=small>
			   								...
			   								<tr>
												{if  $IDSTRING neq ''}
		   	       									<td align="right" valign="top" width="50%" class=small ><font color="red">***</font>  {$APP.LBL_ONLY_SELECTED_RECORDS}</td>
		   										<td align="left" valign="top" width="5%" class=small>
								...
								<tr>
									<td align="right" colspan="2">
										<font color="red">***</font> {$MOD.LBL_DATA_EXPORT_NOT_PARTIAL}
									</td>
								</tr>
								<tr>
									<td align="center" colspan="2" border=0 cellspacing=0 cellpadding=5 width=98% class="layerPopupTransport">
										<input type="button" name="{$APP.LBL_EXPORT}" value="{$APP.LBL_EXPORT} {$MODULELABEL} " class="crmbutton small create" onclick="acc_record_export('{$MODULELABEL}','{$CATEGORY}',this.form,'{$smarty.request.idstring}')"/>&nbsp;&nbsp;
