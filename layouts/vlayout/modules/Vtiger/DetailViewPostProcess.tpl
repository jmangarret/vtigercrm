				...
				<div class="">
					<ul class="nav nav-stacked nav-pills">
						...
						{if $MODULE_NAME == Contacts}
							<li class="" data-label-key="Sincronizar">
								<!-- Modify By jmangarret 08jun2015 -->
								<a href="javascript:void(0);" onclick="javascript: event.stopPropagation();sic_abm({$ID_CONTACTO},{$ID_USER}); ">
									<strong>Sincronizar con ABM</strong>
								</a>
